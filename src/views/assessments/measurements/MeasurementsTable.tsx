...
const MeasurementsTable = ({ customerData }: { customerData?: MeasurementType[] }) => {
  // States
  ...
  const getAvatar = (params: Pick<MeasurementType, 'avatar' | 'player'>) => {
