...
type ECommerceOrderTypeWithAction = PlayerType & {
  action?: string
}
...
const PlayerTable = ({ playerData }: { playerData?: PlayerType[] }) => {
  // States
  ...
  const getAvatar = (params: Pick<PlayerType, 'avatar' | 'player'>) => {
    const { avatar, player } = params
