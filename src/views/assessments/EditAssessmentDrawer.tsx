...
const EditAssessmentDrawer = ({ open, assessment, players, sports, templates, conditions, handleClose, onUpdated }: Props) => {
  ...
  useEffect(() => {
    if (assessment) reset({ playerId: assessment.playerId, sport: assessment.sport, templateId: assessment.templateId, conditionId: assessment.conditionId ?? 0, allowExternalUrls: assessment.allowExternalUrls })
  }, [assessment, reset])
