...
type Props = {
  ...
  metrics: MetricType[]
  handleClose: () => void
  onCreated: (cm: ConditionalMetricType) => void
}

type FormData = { name: string; conditionId: number; metricId: number }

const AddConditionalMetricDrawer = ({ open, conditions, metrics, handleClose, onCreated }: Props) => {
  ...
  return (
    <Drawer open={open} anchor='right' variant='temporary' onClose={handleReset} ModalProps={{ keepMounted: true }} sx={{ '& .MuiDrawer-paper': { width: { xs: 300, sm: 400 } } }}>
      <div className='flex items-center justify-between pli-5 plb-4'>
        <Typography variant='h5'>Add Conditional Metric</Typography>
...
export default AddConditionalMetricDrawer
